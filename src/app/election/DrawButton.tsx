...
export default function DrawButton() {
    ...
    return (<section aria-label="Tirage superadmin" className="mb-6 rounded-2xl border border-orange-200 bg-white p-6">
            ...
            <button type="button" onClick={launchDraw} disabled={pending || Boolean(result?.success)} className="mt-4 rounded-xl bg-orange-600 px-5 py-3 font-semibold text-white hover:bg-orange-700 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-orange-600 disabled:cursor-not-allowed disabled:bg-stone-300">
